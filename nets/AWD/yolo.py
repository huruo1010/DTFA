...
class YOLOPAFPN(nn.Module):
    def __init__(self, depth = 0.33, width = 0.5, in_features = ("dark2","dark3", "dark4", "dark5"), in_channels = [256, 512, 1024], depthwise = False, act = "silu"):
        super().__init__()
        Conv                = DWConv if depthwise else BaseConv
    ...
    def forward(self, input):
        ...
        return (P3_out, P4_out, P5_out), (feat0, feat1, feat2, feat3)
...
class YoloBody(nn.Module):
    ...
    def forward(self, x):
        fpn_outs, guidance    = self.backbone.forward(x)
