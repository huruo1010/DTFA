...
from nets.reconstruction.model import reconstruction
from nets.detection.yolo_training import (get_lr_scheduler, set_optimizer_lr,
                                weights_init)
from utils.IRT.callbacks import LossHistory
from utils.dataloader import YoloDataset, yolo_dataset_collate
from utils.utils import get_classes
from utils.IRT.utils_fit import fit_one_epoch


def parse_args():
    parser = argparse.ArgumentParser(description='Reconstruction Training Script')
    ...
    parser.add_argument('--logs_dir', type=str, default='logs/IRT/', help='Logs directory')
...
def main():
    ...
    for epoch in range(args.init_epoch, args.unfreeze_epoch):
        ...
        fit_one_epoch(
            model_train, model, loss_history, optimizer, epoch,
