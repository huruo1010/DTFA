...
class YoloDataset(Dataset):
    def __init__(self, annotation_lines, clearimage_lines, input_shape, num_classes, epoch_length, mosaic, train,
                 mosaic_ratio=0.7):
    ...
    def __getitem__(self, index):
        ...
        if self.mosaic:
            if self.rand() < 0.5 and self.epoch_now < self.epoch_length * self.mosaic_ratio:
                ...
                image, box, clearimg = self.get_random_data(self.annotation_lines[index], self.clearimage_lines[index],
    ...
    def get_random_data(self, annotation_line, clearimage_line, input_shape, jitter=.3, hue=.1, sat=0.7, val=0.4,
                        random=True):
